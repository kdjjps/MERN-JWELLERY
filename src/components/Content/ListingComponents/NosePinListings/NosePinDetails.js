...
import { addNosePin } from "../../../../store/actions/cartActions";
import { letsShowFlash } from "../../../../store/actions/flashAction";
import { addToWishlist } from "../../../../store/actions/wishlistActions";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faHeart } from "@fortawesome/free-solid-svg-icons";

export default function NosePinDetails() {
  ...
  const stockNumber = pinId.substring(7);
  const nfObject = new Intl.NumberFormat("en-US");

  const item = findJewelry(pins, stockNumber);
    ...
    >
      <div className="details-page-upperbody">
        ...
        <div className="summary-holder">
          <section>
            <p className="heading">{item.productName} Diamond Nose Pin</p>
            <p className="sku">
            ...
            <p className="price">
              ...
              <span style={{ fontSize: "1.3rem", display: "block" }}>
                (Price is for the pin and diamonds, excluding VAT)
              </span>
            </p>
          </section>
