...
const baseImage =
  "https://lgcgems.s3.ap-south-1.amazonaws.com/assets/images/section/view-on-body/base-ear.png";

export default function DiamondSizeLookerForEar({
  status,
  stoneNumber,
  setStoneNumber,
  slider,
  ...
  return (
    ...
    >
      ...
      <div className="earHolder" ref={imgRef}>
        <div className="hand">
          <div className="studMid">
