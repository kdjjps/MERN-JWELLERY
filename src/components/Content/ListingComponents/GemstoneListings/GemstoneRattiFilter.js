...
export default function GemstoneRattiFilter({filterDiamonds}) {

    const [priceLowerBound, setPriceLowerBound] = useState(1)
    const [priceUpperBound, setPriceUpperBound] = useState(14)
    const [priceValue, setPriceValue] = useState([0,14])
    ...
    const onPriceHandleApply = () =>{
        ...
        return (
                <section>
                    <Range max={14} value={priceValue} onChange={onPriceSliderChange}
