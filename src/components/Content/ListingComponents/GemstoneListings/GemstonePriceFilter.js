...
export default function GemstonePriceFilter({filterDiamonds}) {

    const [priceLowerBound, setPriceLowerBound] = useState(1000)
    const [priceUpperBound, setPriceUpperBound] = useState(2500000)
    const [priceValue, setPriceValue] = useState([1000,2500000])
    ...
    const onPriceHandleApply = () =>{
        ...
        return (
                <section>
                    <Range max={2500000} value={priceValue} onChange={onPriceSliderChange}
