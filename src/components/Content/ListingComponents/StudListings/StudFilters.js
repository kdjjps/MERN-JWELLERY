...
import StudPriceFilter from "./StudPriceFilter";
import StudMetalFilter from "./StudMetalFilter";
...
export default function StudFilters({ setParentMetalColor, setShape }) {
