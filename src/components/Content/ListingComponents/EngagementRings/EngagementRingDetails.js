...
import { addFashionRing } from "../../../../store/actions/cartActions";
...
export default function RingDetails() {
  ...
  const stockNumber = ringId.substring(7);
  const nfObject = new Intl.NumberFormat("en-US");

  const item = findJewelry(fashionRings, stockNumber);
    ...
    >
      <div className="details-page-upperbody">
        ...
        <div className="summary-holder">
          <section>
            <p className="heading">{item.productName} Diamond Ring</p>
            <p className="sku">
            ...
            <p className="price">
              <span style={{ fontWeight: "bold" }}>
                ...
                {nfObject.format(
                  getNewArrivalsTotalPrice(
                    "fashion-ring",
                    item.ringSizeWeightArray[ringSize],
                    cookies,
                    smallDiamondPrice,
                    solitaireDiamondPrice,
                    item,
              ...
              <span style={{ fontSize: "1.3rem", display: "block" }}>
                (Price is for the ring and diamonds, excluding VAT)
              </span>
            </p>
          </section>
              ...
              onClick={() => {
                dispatch(
                  addFashionRing({
                    ...
                    ringSizeStandard: ringSizeStandard,
                ...
                dispatch(letsShowFlash("Fashion Ring Added To The Cart"));
              }}
            >
              Add To Bag
            </button>
