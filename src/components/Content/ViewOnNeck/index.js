...
import ViewOnNeckBox from './style.js'
...
export default function ViewOnNeck({status, handleViewHandModal, stoneNumber, setStoneNumber, slider}) {
   ...
   const caratSettings = {
    ...
    return (
        <ViewOnNeckBox status={status} scale={scale} shape={shapes[stoneNumber]} pValue={positionValues[stoneNumber]} tValue={transformValue[weightNumber]}>
