...
const ViewOnEarBox = styled.div`
  ...
  .hand {
    background-image: url("https://lgcgems.s3.ap-south-1.amazonaws.com/assets/images/section/view-on-body/view-on-ear.png");
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
